...
void DIO_setPinInput(unsigned char portnumber,unsigned char pinnumber,unsigned char direction)
{
	switch(portnumber)
		{
		case 0:
...
void initTimer1(void)
{
		...
		SET_BIT(TMOD,4);       //Timer1 mode 1 
    TH1 = 0X00;        //Load the timer value
    TL1 = 0X00;
    TR1 = 1;           //turn ON Timer one
...
void initTimer0(void)
{
		...
		SET_BIT(TMOD,1);       //Timer0 mode 1 
    TH0 = 0XFD;        //Load the timer value
    TL0 = 0XFD;
